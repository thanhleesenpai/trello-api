...
// Cấu hình CORS Option trong dự án thực tế (Video 62)
export const corsOptions = {
  origin: function (origin, callback) {
    // Nếu là môi trường dev thì cho phép tất cả các domain
    if (env.BUILD_MODE === 'dev') {
      return callback(null, true)
    }

    // Nếu không phải môi trường dev thì kiểm tra xem origin có phải là undefined hay không
    if (!origin) {
      return callback(null, true)
    }
